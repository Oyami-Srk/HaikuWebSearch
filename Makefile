...
LIBS =  /boot/system/lib/libroot.so /boot/system/lib/libbe.so /boot/system/lib/libsupc++.so /boot/system/lib/libtranslation.so /boot/system/lib/libstdc++.so
